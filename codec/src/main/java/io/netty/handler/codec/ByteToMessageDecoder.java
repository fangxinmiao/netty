...
public abstract class ByteToMessageDecoder extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        if (msg instanceof ByteBuf) {
            CodecOutList out = CodecOutList.newInstance();
            try {
    ...
    static void fireChannelRead(ChannelHandlerContext ctx, List<Object> msgs, int numElements) {
        if (msgs instanceof CodecOutList) {
            fireChannelRead(ctx, (CodecOutList) msgs, numElements);
        } else {
    ...
    /**
     * Get {@code numElements} out of the {@link CodecOutList} and forward these through the pipeline.
     */
    static void fireChannelRead(ChannelHandlerContext ctx, CodecOutList msgs, int numElements) {
        for (int i = 0; i < numElements; i ++) {
